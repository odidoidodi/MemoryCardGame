...
class MainActivity4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val button41 = findViewById<ImageButton>(R.id.imageButton21)
        val button42 = findViewById<ImageButton>(R.id.imageButton22)
        val button43 = findViewById<ImageButton>(R.id.imageButton23)
        val button44 = findViewById<ImageButton>(R.id.imageButton24)
        val button45 = findViewById<ImageButton>(R.id.imageButton25)
        val button46 = findViewById<ImageButton>(R.id.imageButton26)
        val button47 = findViewById<ImageButton>(R.id.imageButton27)
        val button48 = findViewById<ImageButton>(R.id.imageButton28)
